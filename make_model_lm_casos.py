...
df_googletrends = load('storage/df_export_googletrends_lm.joblib')[FIX_COLUMNS+COLUMNS_SYMPTOMS]
...
df_all_column_coefficients.to_csv('storage/df_all_column_coefficients_lm_casos.csv', index=False)
